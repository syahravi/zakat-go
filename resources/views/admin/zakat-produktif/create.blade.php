...
@section('content')
    ...
    <main class="max-w-screen-xl flex-auto m-10"> <!-- Tambahkan kelas "flex justify-end" -->
        ...
        <form action="{{ route('admin.dashboard.zakat-produktif.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="my-4">
                <label class="block text-gray-700 text-sm font-bold mb-2" for="business">Jenis Usaha</label>
                <input
                    class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                    id="business" name="business" type="text" placeholder="Jenis Usaha">
            </div>
            <div class="my-4">
                <label class="block text-gray-700 text-sm font-bold mb-2" for="amount">Jumlah Dana</label>
                <input
                    class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                    id="amount" name="amount" type="number" placeholder="Jumlah Dana">
            </div>
            <div class="my-4">
