                        ...
                        <div>
                            <h1 class="text-4xl font-bold text-black sm:text-6xl lg:text-7xl">
                                ...
                                <div class="relative inline-flex">
                                    ...
                                    <h1 class="relative text-4xl font-bold text-black sm:text-6xl lg:text-7xl">ZakatProduktif.</h1>
                                </div>
                            </h1>
        
                            <p class="mt-8 text-base text-black sm:text-xl">Ajaran berbagi Islam ditingkatkan lewat platform digital untuk distribusi efisien. Investasi dalam proyek berdampak jadi fokus, manfaat jangka panjang.</p>
        
                            <div class="mt-10 sm:flex sm:items-center sm:space-x-8">
                                <a href="#daftarzakat" title="" class="inline-flex items-center justify-center px-10 py-4 text-base font-semibold text-white transition-all duration-200 bg-green-500 hover:bg-green-600 focus:bg-green-600" role="button"> Zakat Produktif </a>
