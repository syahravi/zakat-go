...
@section('content')
    <div class="container mx-auto">
                    ...
                    <div class="grid items-center grid-cols-1 gap-12 lg:grid-cols-2">
                        <div>
                            <h1 class="text-4xl font-bold text-black sm:text-6xl lg:text-7xl">
                                ...
                                Menebarkan Kebaikan, melalui.
                                <div class="relative inline-flex">
                                    <span class="absolute inset-x-0 bottom-0 border-b-[30px] border-[#4ADE80]"></span>
                                    <h1 class="relative text-4xl font-bold text-black sm:text-6xl lg:text-7xl">Zakatsekarang.</h1>
                                </div>
                            </h1>
        
                            <p class="mt-8 text-base text-black sm:text-xl">Zakat, kewajiban berbagi demi keadilan sosial dalam Islam. Praktik modern mengoptimalkan distribusi melalui platform digital.</p>
        
                            <div class="mt-10 sm:flex sm:items-center sm:space-x-8">
                                <a href="#daftarzakat" title="" class="inline-flex items-center justify-center px-10 py-4 text-base font-semibold text-white transition-all duration-200 bg-green-500 hover:bg-green-600 focus:bg-green-600" role="button"> Zakat Sekarang </a>
        ...
        <h1 class="text-center font-bold text-5xl mt-6"> Daftar Penerima Zakat Sekarang</h1>
