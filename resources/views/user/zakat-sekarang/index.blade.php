                        ...
                        <div>
                            <h1 class="text-4xl font-bold text-black sm:text-6xl lg:text-7xl">
                                ...
                                <div class="relative inline-flex">
                                    ...
                                    <h1 class="relative text-4xl font-bold text-black sm:text-6xl lg:text-7xl">Zakatsekarang.
                                    </h1>
                                </div>
                            </h1>

                            <p class="mt-8 text-base text-black sm:text-xl">Zakat, kewajiban berbagi demi keadilan sosial
                                dalam Islam. Praktik modern mengoptimalkan distribusi melalui platform digital.</p>
        ...
        <div id="daftarzakat" class="mt-10 grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-4">
            @foreach ($zakat_sekarang as $zakat)
                <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow">
                    ...
                    <div class="p-5">
                        <a href="#">
                            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 ">{{ $zakat->name }}</h5>
                        </a>
                        <p class="mb-1 font-normal text-gray-700">{{ $zakat->amil->name }}</p>
                        <button type="button"
                        ...
                        <p class="mt-1 text-green-500 font-bold">Rp{{ $zakat->amount }}</p>
